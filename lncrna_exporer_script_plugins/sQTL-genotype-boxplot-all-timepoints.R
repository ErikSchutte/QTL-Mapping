...
# Load scaled normalized and filtered intron count data
test <- read.table("~/Dropbox/Erik Schutte Internship 2016/Data/Leafcutter/scaled_norm_intron_counts_filtered.csv")

# Genotypes, converted with own MAF.
